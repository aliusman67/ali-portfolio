    ...
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="terminal">
        <div className="terminal-header">
          ...
          <span className="ml-2 text-xs sm:text-sm opacity-50">web-application-security</span>
        </div>
              ...
              return (
                <div key={index} className="border border-green-500/30 rounded-lg p-4 sm:p-6 hover:border-green-500/60 transition-all">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h2 className="text-base sm:text-lg font-bold">{vuln.title}</h2>
                  </div>
                  <p className="text-green-400/80 text-sm sm:text-base mb-4">{vuln.description}</p>
